...
abstract class PaymentDeliveryCondition implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\PaymentCondition\\Model\\Map\\PaymentDeliveryConditionTableMap';
    ...
    /**
     * Initializes internal state of PaymentCondition\Model\Base\PaymentDeliveryCondition object.
     */
    ...
    /**
     * Compares this with another <code>PaymentDeliveryCondition</code> instance.  If
     * <code>obj</code> is an instance of <code>PaymentDeliveryCondition</code>, delegates to
     * <code>equals(PaymentDeliveryCondition)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return PaymentDeliveryCondition The current object, for fluid interface
     */
     ...
     * @return   \PaymentCondition\Model\PaymentDeliveryCondition The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[PaymentDeliveryConditionTableMap::ID] = true;
        }
    ...
    public function setPaymentModuleId($v)
    {
        ...
        if ($this->payment_module_id !== $v) {
            ...
            $this->modifiedColumns[PaymentDeliveryConditionTableMap::PAYMENT_MODULE_ID] = true;
        }
    ...
    public function setDeliveryModuleId($v)
    {
        ...
        if ($this->delivery_module_id !== $v) {
            ...
            $this->modifiedColumns[PaymentDeliveryConditionTableMap::DELIVERY_MODULE_ID] = true;
        }
    ...
    public function setIsValid($v)
    {
        ...
        if ($this->is_valid !== $v) {
            $this->is_valid = $v;
            $this->modifiedColumns[PaymentDeliveryConditionTableMap::IS_VALID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PaymentDeliveryConditionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PaymentDeliveryConditionTableMap::translateFieldName('PaymentModuleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payment_module_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PaymentDeliveryConditionTableMap::translateFieldName('DeliveryModuleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_module_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PaymentDeliveryConditionTableMap::translateFieldName('IsValid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = PaymentDeliveryConditionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \PaymentCondition\Model\PaymentDeliveryCondition object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPaymentDeliveryConditionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PaymentDeliveryCondition::setDeleted()
     * @see PaymentDeliveryCondition::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildPaymentDeliveryConditionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaymentDeliveryConditionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::PAYMENT_MODULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PAYMENT_MODULE_ID';
        }
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::DELIVERY_MODULE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DELIVERY_MODULE_ID';
        }
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::IS_VALID)) {
            $modifiedColumns[':p' . $index++]  = 'IS_VALID';
        }

        $sql = sprintf(
            'INSERT INTO payment_delivery_condition (%s) VALUES (%s)',
    ...
    {
        $pos = PaymentDeliveryConditionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PaymentDeliveryCondition'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PaymentDeliveryCondition'][$this->getPrimaryKey()] = true;
        $keys = PaymentDeliveryConditionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::ID)) $criteria->add(PaymentDeliveryConditionTableMap::ID, $this->id);
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::PAYMENT_MODULE_ID)) $criteria->add(PaymentDeliveryConditionTableMap::PAYMENT_MODULE_ID, $this->payment_module_id);
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::DELIVERY_MODULE_ID)) $criteria->add(PaymentDeliveryConditionTableMap::DELIVERY_MODULE_ID, $this->delivery_module_id);
        if ($this->isColumnModified(PaymentDeliveryConditionTableMap::IS_VALID)) $criteria->add(PaymentDeliveryConditionTableMap::IS_VALID, $this->is_valid);
    ...
    {
        $criteria = new Criteria(PaymentDeliveryConditionTableMap::DATABASE_NAME);
        $criteria->add(PaymentDeliveryConditionTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PaymentCondition\Model\PaymentDeliveryCondition (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \PaymentCondition\Model\PaymentDeliveryCondition Clone of current object.
     * @throws PropelException
     */
    ...
    public function setModuleRelatedByPaymentModuleId(ChildModule $v = null)
    {
        ...
        if ($v !== null) {
            $v->addPaymentDeliveryConditionRelatedByPaymentModuleId($this);
        }
    ...
    public function getModuleRelatedByPaymentModuleId(ConnectionInterface $con = null)
    {
        if ($this->aModuleRelatedByPaymentModuleId === null && ($this->payment_module_id !== null)) {
            $this->aModuleRelatedByPaymentModuleId = ModuleQuery::create()->findPk($this->payment_module_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aModuleRelatedByPaymentModuleId->addPaymentDeliveryConditionsRelatedByPaymentModuleId($this);
             */
        }
    ...
    public function setModuleRelatedByDeliveryModuleId(ChildModule $v = null)
    {
        ...
        // If this object has already been added to the ChildModule object, it will not be re-added.
        if ($v !== null) {
            $v->addPaymentDeliveryConditionRelatedByDeliveryModuleId($this);
        }
    ...
    public function getModuleRelatedByDeliveryModuleId(ConnectionInterface $con = null)
    {
        if ($this->aModuleRelatedByDeliveryModuleId === null && ($this->delivery_module_id !== null)) {
            $this->aModuleRelatedByDeliveryModuleId = ModuleQuery::create()->findPk($this->delivery_module_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aModuleRelatedByDeliveryModuleId->addPaymentDeliveryConditionsRelatedByDeliveryModuleId($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PaymentDeliveryConditionTableMap::DEFAULT_STRING_FORMAT);
    }
